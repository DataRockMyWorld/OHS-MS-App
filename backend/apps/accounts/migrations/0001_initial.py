    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('org_admin', 'Organization Admin'), ('hse_manager', 'HSE Manager'), ('supervisor', 'Supervisor'), ('employee', 'Employee'), ('auditor', 'Auditor')], db_index=True, default='employee', max_length=20)),
